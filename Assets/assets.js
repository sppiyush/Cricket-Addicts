...
export const assets = {
    ...
    {
        id:2,
        title:"How to create an effective Leagues roadmap or ideas",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_2,
        date:Date.now(),
        category:"Leagues",
    ...
    {
        id:3,
        title:"Learning new International to boost your career in software",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_3,
        date:Date.now(),
    ...
    {
        id:6,
        title:"Maximizing returns by minimizing resources in your Leagues",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_6,
        date:Date.now(),
        category:"Leagues",
    ...
    {
        id:7,
        title:"International for Career advancement in development",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_7,
        date:Date.now(),
        category:"International",
    ...
    {
        id:8,
        title:"A comprehensive roadmap for effective Domestic management",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_8,
        date:Date.now(),
        category:"Domestic",
    ...
    {
        id:10,
        title:"Beyond the Ordinary: Crafting Your Exceptional Domestic",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_10,
        date:Date.now(),
        category:"Domestic",
    ...
    {
        id:11,
        title:"Unveiling the Secrets of Successful Leaguess in Technolgy",
        description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the..",
        image:blog_pic_11,
        date:Date.now(),
        category:"Leagues",
